...
public class ModBlockStateProvider extends BlockStateProvider
{
    ...
    protected void registerStatesAndModels()
    {
        ...
        simpleBlockWithItemCubeAll(ModBlocks.ENERGY_RING_CASING);
        ...
        ResourceLocation energy_ring_input_port_front = modLoc("block/energy_ring_input_port_front");
        ResourceLocation energy_ring_output_port_front = modLoc("block/energy_ring_output_port_front");
        ResourceLocation energy_ring_casing = modLoc("block/energy_ring_casing");
        horizontalBlock(ModBlocks.ENERGY_RING_INPUT_PORT.get(), energy_ring_casing, energy_ring_input_port_front, energy_ring_casing);
        itemModels().simpleBlockItem(ModBlocks.ENERGY_RING_INPUT_PORT.get());

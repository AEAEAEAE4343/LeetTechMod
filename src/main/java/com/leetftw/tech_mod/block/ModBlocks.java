...
public class ModBlocks
{
    ...
    public static final DeferredRegister.Items BLOCK_ITEMS = DeferredRegister.createItems(LeetTechMod.MOD_ID);
    ...
    public static final DeferredItem<BlockItem> AESTHETIC_BLOCK_ITEM = BLOCK_ITEMS.registerSimpleBlockItem(AESTHETIC_BLOCK);

    public static final DeferredBlock<GemRefineryBlock> GEM_REFINERY = BLOCKS.registerBlock("gem_refinery",
            GemRefineryBlock::new);
    public static final DeferredItem<BlockItem> GEM_REFINERY_ITEM = BLOCK_ITEMS.register("gem_refinery",
    ...
    public static final DeferredItem<BlockItem> CRYSTALLIZER_ITEM = BLOCK_ITEMS.register("crystallizer",
    ...
    public static final DeferredItem<BlockItem> CRYSTAL_INJECTOR_ITEM = BLOCK_ITEMS.register("crystal_injector",
    ...
    public static final DeferredItem<BlockItem> ENERGY_CELL_ITEM = BLOCK_ITEMS.register("energy_cell",
    ...
    public static final DeferredItem<BlockItem> CREATIVE_ENERGY_CELL_ITEM = BLOCK_ITEMS.register("creative_energy_cell",
    ...
    public static final DeferredItem<BlockItem> BUDDING_AESTHETIC_BLOCK_ITEM = BLOCK_ITEMS.registerSimpleBlockItem(BUDDING_AESTHETIC_BLOCK);
    ...
    public static final DeferredItem<BlockItem> AESTHETIC_CLUSTER_ITEM = BLOCK_ITEMS.registerSimpleBlockItem(AESTHETIC_CLUSTER);
    ...
    public static final DeferredItem<BlockItem> SMALL_AESTHETIC_BUD_ITEM = BLOCK_ITEMS.registerSimpleBlockItem(SMALL_AESTHETIC_BUD);
    ...
    public static final DeferredItem<BlockItem> MEDIUM_AESTHETIC_BUD_ITEM = BLOCK_ITEMS.registerSimpleBlockItem(MEDIUM_AESTHETIC_BUD);
    ...
    public static final DeferredItem<BlockItem> LARGE_AESTHETIC_BUD_ITEM = BLOCK_ITEMS.registerSimpleBlockItem(LARGE_AESTHETIC_BUD);
    ...
    public static final DeferredItem<BlockItem> ENERGY_RING_CONTROLLER_ITEM = BLOCK_ITEMS.register("energy_ring_controller",
    ...
    public static final DeferredItem<BlockItem> ENERGY_RING_CASING_ITEM = BLOCK_ITEMS.registerSimpleBlockItem(ENERGY_RING_CASING);
    ...
    public static final DeferredItem<BlockItem> ENERGY_RING_INPUT_PORT_ITEM = BLOCK_ITEMS.registerSimpleBlockItem(ENERGY_RING_INPUT_PORT);
    ...
    public static final DeferredItem<BlockItem> ENERGY_RING_OUTPUT_PORT_ITEM = BLOCK_ITEMS.registerSimpleBlockItem(ENERGY_RING_OUTPUT_PORT);
    ...
    public static final DeferredItem<BlockItem> QUARRY_CONTROLLER_ITEM = BLOCK_ITEMS.register("quarry_controller",
    ...
    public static final DeferredItem<BlockItem> QUARRY_FRAME_ITEM = BLOCK_ITEMS.registerSimpleBlockItem(QUARRY_FRAME);
